...
public interface Attachment extends Appendix {
    ...
    public final static class QaqMiningRewardRecipientAssignment extends AbstractAttachment {
    	
    	QaqMiningRewardRecipientAssignment(ByteBuffer buffer, byte transactionVersion) {
    		super(buffer, transactionVersion);
    	}
    	
    	QaqMiningRewardRecipientAssignment(JSONObject attachmentData) {
    		super(attachmentData);
    	}
    	
    	public QaqMiningRewardRecipientAssignment() {
    	}
        ...
        @Override
        public TransactionType getTransactionType() {
            return TransactionType.QaqMining.REWARD_RECIPIENT_ASSIGNMENT;
        }
    }
