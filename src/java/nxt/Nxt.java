...
public final class Nxt {
    ...
    static {
        System.out.println("Initializing Qaq server version " + Nxt.VERSION);
    ...
    public static void shutdown() {
        ...
        ThreadPool.shutdown();
        Db.shutdown();
        Logger.logShutdownMessage("Qaq server " + VERSION + " stopped.");
        Logger.shutdown();
    }
    ...
    private static class Init {
        ...
        static {
            try {
                ...
                Logger.logMessage("Qaq server " + VERSION + " started successfully.");
